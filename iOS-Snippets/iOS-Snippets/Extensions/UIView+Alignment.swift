...
extension UIView {
    ...
    func alignToView(_ otherView : UIView, horizontal:  HorizontalAlign, vertical : VerticalAlign , horizontalOffset : CGFloat = 0.0, verticalOffset : CGFloat = 0.0) {
...
func alignedHorizontalOriginWithFrame(_ source : CGRect,  dest : CGRect, align : HorizontalAlign) -> CGFloat {
...
func alignedVerticalOriginWithFrame(_ source : CGRect,  dest : CGRect, align : VerticalAlign) -> CGFloat {
    var origin = source.origin.x
